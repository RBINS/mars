...
LocationSchema = Schema((
    ...
    TextField(
        ...
        widget=RichWidget(label='Link to an external map',
            label_msgid='label_detailed_geomapping',
            description='Link to an external map like google',
