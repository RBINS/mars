...
Objects that you can edit and get things overidden are:
    ...
    - mars.testing.tests.user_testcase:
    ...
    - mars.testing.tests.layers.user_layer.layer::

        A zope.testing layer to wire your tests

    - mars.testing.tests.user_utils:

        utilities functions to register as a global in tests

    - mars.testing.tests.user_globals:
...
try:from mars.testing.tests.globals import *
except:pass
try:from mars.testing.tests.user_globals import *
except:pass
...
try:from mars.testing.tests.user_testcase import setUp
except:pass
try:from mars.testing.tests.user_testcase import tearDown
except:pass
...
try:
    ...
    try:
        from mars.testing.tests.user_testcase import DocTestCase
    except:pass
    #       from Testing import ZopeTestCase as ztc
...
def test_doctests_suite(directory=__file__,
    ...
    No need to copy and duplicate this file, it is useless.
      ...
      >>> from mars.testing.tests.test_setup import test_doctests_suite as ts
      >>> def test_suite():
      ...     globs = globals()
    ...
    if files:
        for test in files:
            ...
            if HAS_ZOPE2:
                ...
                from mars.testing.tests.test_doctests import setUp, tearDown
                if lsetUp:
                    setUp=lsetUp
                if ltearDown:
                    tearDown=ltearDown
