...
class Layer(BasePTCLayer):
    ...
    def afterSetUp(self):
        """Set up the additional products required for the mars) site policy.
    ...
    #with_ploneproduct_csvreplica
        ...
        self.loadZCML('configure.zcml', package=Products.csvreplicata)   
    #with_ploneproduct_contentwellportlet
        import Products.ContentWellPortlets
        self.loadZCML('configure.zcml', package=Products.ContentWellPortlets)   
    #with_ploneproduct_tinymce
    ...
    #with_ploneproduct_ploneappblob
        ...
        ztc.installPackage('mars.policy')
        ztc.installPackage('mars.skin')
        ztc.installPackage('mars.tma') 
