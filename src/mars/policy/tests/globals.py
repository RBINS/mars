...
try:from mars.policy import app_config
except:pass


# try to import, but not fail as we can do without (for example in a thirdparty which adapt the testcase)
try: from mars.policy.app_config import GLOBALS
except:pass
try: from mars.policy.app_config import PRODUCT_DEPENDENCIES
except:pass
try: from mars.policy.app_config import SKIN
except:pass
try:from mars.policy.tests_tools import getWorkflows
except:pass
...
try: from mars.policy.tests.user_globals import *
except: pass
