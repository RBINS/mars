...
AnalysisSchema += Schema((
    ...
    ReferenceField('laboratory',
        ...
        widget=ReferenceWidget(label='Laboratory',
    ...
    TextField('sampleAndContext',
        ...
        widget=TextAreaWidget(label='Sample and context',
    ...
    TextField('protocols',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Sampling and analysis protocol(s)',
    ...
    TextField('results',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Result(s)',
    ...
    TextField('originalComments',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Raw Comments',
...
AbsoluteDatingAnalysisSchema += Schema((
    ...
    TextField('calibratedAge',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Calibrated Age',
...
RelativeDatingAnalysisSchema += Schema((
    ...
    TextField('chronologyDetails',
        ...
        widget=TextAreaWidget(label='Chronology Details',
