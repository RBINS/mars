...
AnalysisSchema += Schema((
    ...
    ReferenceField('resultsFile',
        required=False,
        searchable=False,
        relationship='hasResultsFile',
        allowed_types=FILE_TYPES,
        widget=ReferenceBrowserWidget(label='Results file',
            label_msgid='label_feasures_file',
            description='Upload a file describing the item results.',
