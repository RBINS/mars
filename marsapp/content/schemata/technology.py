...
TechnologySchema = Schema((
    ...
    TextField('manufacturePreciseDate',
        ...
        widget=TextAreaWidget(label='Precise Date',
    ...
    TextField('technologyDetails', 
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Technology details',
    ...
    TextField('functionalDescription',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Functional Description',
    ...
    TextField('usageMarkers',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Markers of Usage',
