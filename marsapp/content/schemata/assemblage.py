...
AssemblageSchema = Schema((
    ...
    TextField('MNIDetermination',
        ...
        widget=TextAreaWidget(label='Minimal number of individuals determination',
    ...
    ReferenceField('components',
        ...
        widget=ReferenceBrowserWidget(label='Remain components',
    ...
    TextField('attributionInfo',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Attribution Information',
...
BioAssemblageSchema = Schema((
    ...
    TextField('originDetermination',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Origin Determination',
    ...
    TextField('paleoecology',
        ...
        allowable_content_types=('text/plain',),
        default_output_type='text/x-html-safe',
        widget=TextAreaWidget(label='Paleoecology',
